...
// Todo o CSS necessário está aqui dentro, com novos estilos para as informações do relatório.
const STYLES = `
  :root {
    --cor-primaria: #a13751;
    --cor-fundo: #f8f8f8;
  ...
  /* --- NOVO ESTILO PARA AS INFORMAÇÕES DO RELATÓRIO --- */
          ...
          <div key="dashboard" className="view-container">
            <main>
              <div className="card">
                ...
                <div className="botoes-acao">
                  <button className="btn-secundario" onClick={voltarParaBusca}>Voltar</button>
        ...
        return (
          <div key="resultado" className="view-container">
            <main className="card resultado-card">
              ...
              {/* --- NOVA SEÇÃO DE INFORMAÇÕES GERAIS --- */}
