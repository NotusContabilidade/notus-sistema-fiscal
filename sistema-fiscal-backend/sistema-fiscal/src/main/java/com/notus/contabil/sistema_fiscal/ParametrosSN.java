...
@Entity
@Table(name = "parametros_sn") // Schema removido
public class ParametrosSN {
    ...
    @Column(name = "rbt12_atual", nullable = false)
    private Double rbt12Atual;

    @Column(name = "folha_pagamento_12m_atual", nullable = false)
    private Double folhaPagamento12mAtual;
